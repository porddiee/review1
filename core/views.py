...
def start_quiz(request, topic_id):
    ...
    questions = questions[:10]  # change as needed
    ...
    if request.method == 'POST':
        ...
        return render(request, 'core/quiz_result.html', {'score': score, 'total': total, 'topic': topic})
    else:
        return render(request, 'core/quiz_start.html', {'topic': topic, 'questions': questions})
